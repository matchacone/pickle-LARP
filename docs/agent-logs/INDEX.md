...
| 2026-07-07 | `auth-flow-backend` | Auth middleware, useAuth hook, logout action, auth-aware Navbar | complete | `client/middleware.ts`, `client/hooks/useAuth.ts`, `client/app/actions/auth-actions.ts`, `client/components/layout/Navbar.tsx` |
| 2026-07-07 | `court-reviews-api` | Court reviews CRUD API and reviews section on court detail page | complete | `client/app/api/courts/[id]/reviews/route.ts`, `client/app/api/reviews/[id]/route.ts`, `client/lib/db/queries/courtQueries.ts` |
| 2026-07-08 | `payment-service` | PaymentService interface, mock impl, payment API endpoints, mock checkout page, checkout wiring | complete | `client/lib/payment/index.ts`, `client/lib/payment/mock.ts`, `client/lib/db/queries/paymentQueries.ts`, `client/app/api/payments/initiate/route.ts`, `client/app/api/payments/webhook/route.ts`, `client/app/(checkout)/mock-payment/page.tsx`, `client/app/(checkout)/checkout/page.tsx` |
| 2026-07-20 | `owner-onboarding` | Facility Owner Onboarding form, Supabase Storage uploads, and Admin approval workflow | complete | `client/app/(customer)/apply-owner/page.tsx`, `client/app/api/applications/route.ts`, `client/app/admin/applications/page.tsx`, `client/app/admin/applications/ClientPage.tsx`, `client/app/api/admin/applications/[id]/route.ts`, `client/lib/db/schema.ts` |
| 2026-07-20 | `court-images` | Real court image uploads and public storage | complete | `client/app/(owner)/my-court/page.tsx`, `client/components/features/CourtCard.tsx`, `client/lib/db/schema.ts` |
